...
Every entry above is kept for its reasoning. The ones marked DONE,
SHIPPED, FIXED or ANSWERED are decision records; the rest are open and
appear in BACKLOG.md under a heading that says which kind of work they
are.
